  ...
  sv: {
    ...
    wishlists: {
      ...
      dataTable: {
        ...
        columns: "Kolumner",
        title: "Titel",
        wishCount: "Önskningar",
        averagePriceShort: "Snitt.",
    ...
    settings: {
      ...
      deleteAccount: {
        headline: "Är du säker?",
        description:
          "När du tar bort din konto, finns det ingen återställning. Vär säker på det.",
        button: "Ta bort konto",
        delete: "Ta bort konto",
        cancel: "Avbryt",
        success: "Din konto har blivit raderad",
      },
    },
  },
  es: {
    ...
    settings: {
      ...
      deleteAccount: {
        headline: "¿Estás seguro?",
        description:
          "Cuando eliminas tu cuenta, no hay vuelta atrás. Asegúrate de que quieres hacerlo.",
